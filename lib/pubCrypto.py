...
class PubRSAKey:
    def __init__(self, key_str=None, key_fname=None,
...
class RSAKey(PubRSAKey):
    def __init__(self, key_str=None, key_fname=None,
        ...
        PubRSAKey.__init__(self, key_str, key_fname,
                           encryption_padding, sign_algo)
        return
    ...
    def PubRSAKey(self):
        ...
        public_key = bio.read()
        return PubRSAKey(key_str=public_key,
    ...
    def save_to_bio(self, bio):
        ...
        return self.rsa_key.save_key_bio(bio, self.private_cipher,
