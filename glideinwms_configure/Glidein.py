...
class Glidein(Configuration):
    ...
    def validate_web_location(self):
        dir_name = self.web_location()
        common.logit("... validating web_location: %s" % dir_name)
        common.make_directory(dir_name, self.username(), 0755)
...
def main():
    try:
        ...
        _ = Glidein(options.inifile, "Factory", valid_options)
