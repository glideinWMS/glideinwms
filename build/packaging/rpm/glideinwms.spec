...
Two packages exist (factory and vofrontend) plus dependent
condor packages for additional condor customizability.
...
access the Grid resources. GlideinWMS is a Glidein Based
