...
class VOFrontendParams(cWParams.CommonParams):
    ...
    def init_defaults(self):
        ...
        group_config_idle_defaults["reserve"] = [
            "5",
            "nr_jobs",
        ...
        group_config_removal_defaults["margin"] = [
            "0",
            "NR",
            "How closely to follow the number of requests",
            None,
        ]
        ...
        schedd_defaults["fullname"] = (
            None,
            "name",
            "User schedd name (for example, schedd_3@sb1.my.org)",
            None,
        )
        schedd_defaults["DN"] = (
            None,
        ...
        fj_match_defaults["query_expr"] = [
            "True",
            "CondorExpr",
            "Expression for selecting user jobs",
            None,
        ]
        ...
        job_match_defaults["schedds"] = (
            [],
            "List of user schedds",
            "Each schedd contains",
            schedd_defaults,
        )
        ...
        proxy_defaults["absfname"] = (
            None,
            "fname",
            "x509 proxy file name (see also pool_idx_list)",
            None,
        )
        proxy_defaults["keyabsfname"] = (
            None,
            "fname",
            "for key files, file name of the key pair",
            None,
        )
        ...
        proxy_defaults["creation_script"] = (
            None,
            "command",
            "Script to re-create credential",
            None,
        )
        proxy_defaults["update_frequency"] = (
            None,
            "int",
            "Update proxy when there is this much time left",
            None,
        )
        proxy_defaults["remote_username"] = (
            None,
            "username",
            "User name at the remote resource",
            None,
        )
        ...
        proxy_defaults["pool_idx_list"] = (
            None,
            "string",
            "List of indices, can include ranges of indices",
            None,
        )
        ...
        proxy_defaults["vm_id_fname"] = (
            None,
            "fname",
            "to specify a vm id without reconfig",
            None,
        )
        proxy_defaults["vm_type_fname"] = (
            None,
            "fname",
            "to specify a vm type without reconfig",
            None,
        )
        proxy_defaults["project_id"] = (
            None,
            "string",
            "OSG Project ID. Ex TG-12345",
            None,
        )
        ...
        self.defaults["downtimes_file"] = (
            "frontenddowntime",
            "string",
            "Frontend Downtime File",
            None,
        )
        self.defaults["frontend_name"] = (
            socket.gethostname(),
            "ID",
            "VO Frontend name",
            None,
        ...
        work_defaults["base_dir"] = (
            "%s/frontstage" % os.environ["HOME"],
            "base_dir",
            "Frontend base dir",
            None,
        )
        work_defaults["base_log_dir"] = (
            "%s/frontlogs" % os.environ["HOME"],
            "log_dir",
            "Frontend base log dir",
            None,
        )
        ...
        process_log_defaults["max_days"] = [
            "7.0",
            "days",
            "Max number of days the logs should be preserved",
            None,
        ]
        process_log_defaults["max_mbytes"] = [
            "100.0",
            "Mbytes",
        ...
        stage_defaults["use_symlink"] = (
            "True",
            "Bool",
            "Can I symlink stage dir from work dir?",
            None,
        )
        ...
        self.monitor_defaults["web_base_url"] = (
            None,
            "web_base_url",
            "Monitoring base dir",
            None,
        ...
        ccb_defaults["node"] = (
            None,
            "nodename",
            "CCB collector node name (for example, ccb1.my.org:9999)",
            None,
        )
        ccb_defaults["DN"] = (
            None,
        ...
        ccb_defaults["group"] = (
            "default",
            "string",
            "CCB collector group name useful to group HA setup",
            None,
        )
        self.defaults["ccbs"] = (
            [],
            "List of CCB collectors",
            "Each CCB contains",
            ccb_defaults,
        )
        ...
        ha_defaults["ha_frontends"] = (
            [],
            "List of frontends in  HA mode",
            "Each element contains",
            haf_defaults,
        )
        ha_defaults["enabled"] = ("False", "Bool", "Enable HA?", None)
        ha_defaults["check_interval"] = (
            "300",
            "NR",
            "How frequently should slav check if the master is down",
            None,
        )
