...
#
# File Version: 
#   $Id: cgWParams.py,v 1.63.2.7.4.2 2011/04/28 19:07:35 klarson1 Exp $
#
# Desscription:
...
class GlideinParams(cWParams.CommonParams):
    ...
    def init_defaults(self):
        ...
        self.entry_defaults["auth_methods"] = ('grid_proxy', 'auth_methods', 'Type of auth method this entry supports', None)
