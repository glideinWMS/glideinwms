...
class glideinEntryDicts(cgWDictFile.glideinEntryDicts):
    ...
    def populate(self, entry, schedd):
        ...
        self.dicts['vars'].add_extended("GLIDEIN_REQUIRE_VOMS", "bool", restrictions[u'require_voms_proxy'], None, False, True, True)
        self.dicts['vars'].add_extended("GLIDEIN_REQUIRE_GLEXEC_USE", "bool", restrictions[u'require_glidein_glexec_use'], None, False, True, True)
