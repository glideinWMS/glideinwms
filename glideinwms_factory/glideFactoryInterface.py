...
def findWork(factory_name, glidein_name, entry_name,
    ...
    status = glideinwms_libs.condorMonitor.CondorStatus("any")
...
def exe_condor_advertise(fname, command,
                         is_multi=False):
    return glideinwms_libs.condorManager.condorAdvertise(fname, command, factoryConfig.advertise_use_tcp, is_multi)
