...
#
# File Version: 
#   $Id: glideFactoryLogParser.py,v 1.15.12.7 2011/05/04 20:57:09 dstrain Exp $
#
# Description:
...
rawTime2cTime = glideinwms_libs.condorLogParser.rawTime2cTime

class logSummaryTimingsOut(glideinwms_libs.condorLogParser.logSummaryTimings):
    """
    ...
    def loadFromLog(self):
        ...
        """
        glideinwms_libs.condorLogParser.logSummaryTimings.loadFromLog(self)
...
class dirSummaryTimingsOut(glideinwms_libs.condorLogParser.cacheDirClass):
    """
...
class dirSummaryTimingsOutFull(glideinwms_libs.condorLogParser.cacheDirClass):
    """
    This class uses a lambda function to initialize an instance
    of cacheDirClass.
    The function chooses all condor_activity files in a directory
