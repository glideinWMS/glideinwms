...
class GlideinParams(cWParams.CommonParams):
    ...
    def init_defaults(self):
        ...
        entry_config_max_jobs_defaults["max_job_frontends"] = (glideinwms_libs.xmlParse.OrderedDict(), 'Dictionary of frontends', "Each frontend entry contains", self.max_job_frontend_defaults)
        ...
        sub_defaults = {'attrs':(glideinwms_libs.xmlParse.OrderedDict(), 'Dictionary of attributes', "Each attribute entry contains", self.attr_defaults),
        ...
        self.entry_defaults["allow_frontends"] = (glideinwms_libs.xmlParse.OrderedDict(), 'Dictionary of frontends', "Each frontend entry contains", self.allow_defaults)
        ...
        self.frontend_defaults["security_classes"] = (glideinwms_libs.xmlParse.OrderedDict(), "Dictionary of security class maps", "Each mapping contains", self.frontend_sec_class_defaults)
        ...
        security_default["frontends"] = (glideinwms_libs.xmlParse.OrderedDict(), "Dictionary of frontend", "Each frontend contains", self.frontend_defaults)
        ...
        self.defaults["entries"] = (glideinwms_libs.xmlParse.OrderedDict(), "Dictionary of entries", "Each entry contains", self.entry_defaults)
...
def find_condor_base_dir():
    if glideinwms_libs.condorExe.condor_bin_path == None:
        return None
    else:
        return os.path.dirname(glideinwms_libs.condorExe.condor_bin_path)
