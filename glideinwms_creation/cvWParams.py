...
class VOFrontendParams(cWParams.CommonParams):
    ...
    def init_defaults(self):
        ...
        sub_defaults = {'attrs':(glideinwms_libs.xmlParse.OrderedDict(), 'Dictionary of attributes', "Each attribute group contains", self.attr_defaults),
        ...
        fj_match_defaults["match_attrs"] = (glideinwms_libs.xmlParse.OrderedDict(), "Dictionary of ClassAd attributes", "Each attribute contains", query_attrs_defaults)
        ...
        self.defaults["groups"] = (glideinwms_libs.xmlParse.OrderedDict(), "Dictionary of groups", "Each group contains", self.group_defaults)
