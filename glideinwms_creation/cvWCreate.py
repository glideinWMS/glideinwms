...
import glideinwms_libs.condorSecurity
...
def create_client_condor_config(config_fname, mapfile_fname, collector_nodes):
    attrs = glideinwms_libs.condorExe.exe_cmd('condor_config_val', '-dump')
    ...
    try:
        ...
        for context in glideinwms_libs.condorSecurity.CONDOR_CONTEXT_LIST:
