...
- Added CachedGenerator base class to implement genrators with automatic cache management
- Added CredentialGenerator base genrator class to implement cached credential generators
