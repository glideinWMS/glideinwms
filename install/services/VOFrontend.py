...
""")
    default_factory_attributes = str.join(',', self.extract_factory_attrs())
...
please verify and correct if needed.
""")
    default_job_attributes = str.join(',', self.extract_job_attrs())
...
%(indent5)s<match_attrs> """ % \
 { "indent4": common.indent(4),
   ...
   "expr": glideinwms.lib.xmlFormat.xml_quoteattr(str.join(" && ", attr_query_arr)),}
