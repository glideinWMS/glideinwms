...
class TestFrontendConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if self.debug_output:
            ...
            print(
                'group_signature_descript = %s' %
                self.group_signature_descript)
            ...
            print('\ndir element_merged_descript = %s' %
                  dir(self.element_merged_descript))
    ...
    def test_get_group_dir(self):
        self.assertEqual(
            'fixtures/frontend/group_group1',
            get_group_dir(
                'fixtures/frontend',
                'group1'))
...
class TestStageFiles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.stage_files = StageFiles(
            'fixtures/frontend/web-area/stage',
