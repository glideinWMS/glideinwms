...
class TestSHA1DictFile(unittest.TestCase):
    ...
    def test_format_val(self):
        expected = 'ad0f57615c3df8bbb2130d96cfdf09363f4bd3ed  description.e98f4o.cfg  group_main'
        self.assertEqual(expected, self.dic.format_val('description.e98f4o.cfg  group_main', None))
...
class TestSummarySHA1DictFile(unittest.TestCase):
    ...
    def test_init(self):
        ...
        #self.assertEqual([],  self.dic.keys)
