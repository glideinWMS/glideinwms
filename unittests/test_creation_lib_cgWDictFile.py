...
class TestcgWDictFile(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.entry_dicts = get_entry_dicts(self.submit_dir, self.stage_dir, 'entry_el6_osg34')
    ...
    def test_format_val_MonitorGroupDictFile(self):
        ...
        # FIXME
        # self.assertNotEqual(no_c, has_c)
    ...
    def test_load_entry_dicts(self):
       load_entry_dicts(self.entry_dicts, 'el6_osg34', self.entry_dicts['signature'])
